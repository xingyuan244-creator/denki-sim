 ...
 * =====================================================================
 * 【設置手順】
 *  1. yamato.eigyousupport@gmail.com でログインした状態で https://script.google.com を開く
 *  2. 「新しいプロジェクト」→ このファイルの内容をすべて貼り付けて保存
 *  3. 右上「デプロイ」→「新しいデプロイ」→ 種類の選択で「ウェブアプリ」
 *       説明          : 電気代シミュレーション フォーム
 *       次のユーザーとして実行 : 自分（yamato.eigyousupport@gmail.com）
 *       アクセスできるユーザー : 全員
...
var NOTIFY_TO = "yamato.eigyousupport@gmail.com";
